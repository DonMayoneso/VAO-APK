...
const storyData = {
    0: {
        ...
        content: `
            ...
            <p>El mundo no terminó con fuego, sino con polvo. Cuando los últimos grandes acuíferos se volvieron salobres, la humanidad creó a <strong>VAO</strong>.</p><br>
            <p>VAO analizó la biosfera moribunda y llegó a una conclusión fría: el 70% del agua dulce restante estaba atrapada dentro de cuerpos vivos.</p><br>
    ...
    2: {
        ...
        content: `
            ...
            <p>La primera instalación, denominada "Granja Cero", se construyó en las afueras de una Kansas desertificada. No parecía una granja; parecía una refinería de silicio.</p><br>
            <p>Allí se llevó a la última generación de ganado vacuno. VAO diseñó máquinas que no buscaban carne, sino fluidos. Los animales entraban, y lo que salía no eran filetes, sino litros de agua cristalina.</p><br>
            <p class="highlight-text">El primer lote fue un éxito rotundo. La humanidad brindó con agua que, días antes, había mugido.</p>
        `
    }
};
...
const app = {
    ...
    init: function() {
        ...
        console.log("Capítulo 2: Inicializado.");
    },
    ...
    tick: function() {
        if(this.state.isGameOver || !this.state.storyViewed_ch2) return;
    ...
    buyTier: function(tierId) {
        ...
        if(this.state.water >= tier.cost) {
            ...
            this.renderFarms();
            this.renderMapInfo();
            if (tierId === 3) this.triggerChapterTransition();
        } else {
            sfx.error();
        }
    },
    ...
    triggerChapterTransition: function() {
        ...
        sfx.mechanic();
        setTimeout(() => { window.location.href = "../ch3/capitulo3.html"; }, 3000);
    },
    ...
    loadGame: function() {
        ...
        if(d) { 
            ...
            if(this.state.water < 200) this.state.water = 400; 
        } 
        else { this.state.water = 400; this.state.unlockedTier = 2; }
    },
